...
public class Ticket {
    ...
    public double distance;//km , mesafe

    public int typeNo;//yon 1 mi 2 mi

    public String seatNo;//koltuk no
    ...
    public void getTotalPrice(int age){
        double total=0;
        int seat=Integer.parseInt(this.seatNo); //String ifade mi int cevirdik
        switch (this.typeNo){
